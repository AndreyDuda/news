...
@foreach($news as $item)
    <div class="col" style="border:1px solid grey; margin:10px;">
        ...
        <span style="font-weight: 600; font-size: 13px;"> {!! $item->desc !!}</span><br /><span style="font-weight: 900">Автор : {{ $item->user->name }}</span> <span style="float:right; font-weight: 900"> {!! $item->created_at !!}</span>
        <br />
